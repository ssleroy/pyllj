...
def compute_isohypses_climatology( yearrange:{tuple,list}, dataroot:str ): 
    """Compute a climatology of isohypsic analysis over range of years previously 
    generated compute_isohypses. 
    ...
    The output is written into the the isohypses directory as isohypses.YYYY-YYYY.nc"""
    ...
    o.setncatts( { 
        'file_type': "model-isohypsic_analysis_climatology", 
...
def main(): 
    ...
    parser = argparse.ArgumentParser( description="Generate an annual cycle, diurnal " + \
            ...
            "based on the output of compute_isohypses" )
    ...
    ret = compute_isohypses_climatology( yearrange, args.dataroot ) 
